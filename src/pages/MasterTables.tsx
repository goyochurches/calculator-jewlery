          ...
          return (
            <div key={m.id} className="rounded-2xl border border-slate-100 bg-white p-4 shadow-sm">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-6">
                ...
                <div className="space-y-1">
                  <label className="text-[11px] font-semibold uppercase tracking-wide text-slate-400">Default type</label>
                ...
                <div className="space-y-1">
                  <label className="text-[11px] font-semibold uppercase tracking-wide text-slate-400">Natural key</label>
                  <TInput value={dr.diamondSizeKey} onChange={e => patch(m.id, { diamondSizeKey: e.target.value })} />
                </div>
                <div className="space-y-1">
                  <label className="text-[11px] font-semibold uppercase tracking-wide text-slate-400">Lab key</label>
                  <TInput value={dr.diamondSizeKeyLab ?? ''} onChange={e => patch(m.id, { diamondSizeKeyLab: e.target.value })} />
                </div>
              </div>
