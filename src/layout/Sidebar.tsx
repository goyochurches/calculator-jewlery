...
const navItems: { to: string; label: string; icon: typeof LayoutDashboard; key: NavKey; hidden?: boolean }[] = [
  ...
  { to: '/stock', label: 'Stock Builder', icon: Package, key: 'stock' },
  { to: '/stock-list', label: 'Stock', icon: Package, key: 'stock-list' },
...
const navTourCopy: Partial<Record<NavKey, string>> = {
  ...
  stock: 'Price and catalog pieces the store already has in stock.',
  'stock-list': 'Every stock piece, with quantity and status.',
